...
urlpatterns = [
    ...
    path('chat/<int:contato_id>/', lista_chats, name='chat'),
    path('chat/<int:contato_id>/enviar/', enviar_mensagem, name='enviar_mensagem'),
    path('projeto/<int:projeto_id>/iniciar_conversa/', iniciar_contato, name='iniciar_conversa'),
    ...
    path('feedbacks/', feedbacks, name='feedbacks'),    path('feedbacks-geral/', feedbacks_todos, name='feedbacks_todos'),  # todos os feedbacks
