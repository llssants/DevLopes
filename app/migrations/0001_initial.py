# Generated by Django 5.2.3 on 2025-10-06 17:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('disponivel', 'Disponivel'), ('andamento', 'Em andamento'), ('concluido', 'Concluído')], default='andamento', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Tecnologia',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linguagens', models.JSONField(blank=True, null=True)),
